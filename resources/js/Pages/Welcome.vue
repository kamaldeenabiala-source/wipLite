...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        />
        <div
            class="relative flex min-h-screen flex-col items-center justify-center selection:bg-orange-500 selection:text-white"
        >
                ...
                >
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        <Link
                            ...
                            class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-orange-500 dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                        >
                            Dashboard
                        </Link>
